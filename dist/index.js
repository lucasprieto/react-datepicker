      ...
      return (
        ...
        _defineProperty(_assertThisInitialized(r), "handleChange", function() {
          ...
          if (
            ...
            (!o && a.target.value) || r.setSelected(o, a, !0, !1);
          }
        }),
        ...
        _defineProperty(_assertThisInitialized(r), "setSelected", function(
          ...
          var i = e;
          if (null === i || !isDayDisabled(i, r.props)) {
            if (!isEqual(r.props.selected, i) || r.props.allowSameDay) {
              if (null !== i) {
                if (r.props.selected) {
                ...
                r.props.inline || r.setState({ preSelection: i }),
                  r.props.inline &&
                    r.props.monthsShown > 1 &&
                    !r.props.inlineFocusSelectedMonth &&
                    r.setState({ monthSelectedIn: a });
              }
              r.props.onChange(i, t);
            }
            o && r.props.onSelect(i, t), n || r.setState({ inputValue: null });
          }
        }),
