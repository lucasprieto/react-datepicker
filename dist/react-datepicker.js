        ...
        return (
          ...
          de(De(o), "handleChange", function() {
            ...
            if (
              ...
              (!a && n.target.value) || o.setSelected(a, n, !0, !1);
            }
          }),
          de(De(o), "handleSelect", function(e, t, r) {
            o.setState({ preventFocus: !0 }, function() {
              ...
              o.setSelected(e, t, void 0, r, !0),
              !o.props.shouldCloseOnSelect || o.props.showTimeSelect
                ? o.setPreSelection(e)
                : o.props.inline || o.setOpen(!1);
          }),
          de(De(o), "setSelected", function(e, t, r, n, a) {
            var s = e;
            if (null === s || !Ae(s, o.props)) {
              if (!Ie(o.props.selected, s) || o.props.allowSameDay) {
                if (null !== s) {
                  if (o.props.selected) {
                    var i = o.props.selected;
                    r && (i = Ce(s)),
                      (s = Oe(s, { hour: k(i), minute: g(i), second: w(i) }));
                  }
                  o.props.inline || o.setState({ preSelection: s }),
                    o.props.inline &&
                      o.props.monthsShown > 1 &&
                      !o.props.inlineFocusSelectedMonth &&
                      o.setState({ monthSelectedIn: n });
                }
                o.props.onChange(s, t);
              }
              a && o.props.onSelect(s, t),
                r || o.setState({ inputValue: null });
            }
          }),
